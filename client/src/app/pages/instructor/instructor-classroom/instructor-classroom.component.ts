...
export class InstructorClassroomComponent implements OnInit, OnDestroy {
  ...
  instructorClassroom!: Array<Session>;
  ...
  updateContent = (args: any, eventName: any) => {
    ...
    this.updateContentTimer = setTimeout(() => {
      if (this.instructorClassroom.length) {
        switch (editorMode) {
          case 'NORMAL':
  ...
  sourceDataListener() {
    return this.sessionStore.$selectedSession.subscribe((data: any) => {
      this.instructorClassroom = data;
    });
  }
