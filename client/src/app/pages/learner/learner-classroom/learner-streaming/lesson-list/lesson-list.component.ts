...
export class LessonListComponent implements OnInit, OnDestroy, OnChanges {
  ...
  @Input() insertAsset: (asset: any, type: string, thumbnail: string) => void;
  @Input() closePopupLesson: () => void;
  ...
  exportLesson(e: any) {
    ...
    // console.log(e);
    this.insertAsset(e,'lesson', thumbnail);
  }
  ...
  onSearchKeyupHandler(e: any) {
    ...
    this.timeout = setTimeout(() => {
      ...
      if (this.currentSearchByPropertyValue !== '') {
        this.lessonStore.initInfiniteFilterSearchByPropertyData(
          this.currentFilterProperty,
          this.currentFilterByPropertyValue,
          this.currentSearchProperty,
          this.currentSearchByPropertyValue,
...
export class LessonMessageListModule {}
